...
import { currentUser_currentUser_posts } from '../generated/currentUser';
...
export type IProfileGridProps = {
    columns: currentUser_currentUser_posts[][];
};
...
export type IStoreAction =
    ...
    | { type: 'SET_NEW_POSTS'; payload: Feed_feed }
